...
window.onload = function () {
	...
	sprite.onload = checkResourcesLoaded

	finishSprite = new Image()
	finishSprite.src = '../images/home.png'
	finishSprite.onload = checkResourcesLoaded
...
function showWinModal(moves) {
	stopTimer()
	document.querySelector('#win-modal p').textContent =
		'Лабиринт был пройден всего за ' + elapsedTime + ' сек.'
...
function makeMaze() {
	if (!isReady) {
		alert('Игра ещё загружается. Пожалуйста, подождите!')
		return
	}
	...
	player = new Player(maze, mazeCanvas, cellSize, showWinModal, sprite)
